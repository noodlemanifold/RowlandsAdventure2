...
public class RenderStates
{
	...
	private int customRenderProgramIndex = -1;
	private boolean isPlanet = false;
	private Vector4f shadowLightDirection = new Vector4f(0f,1f,0f,0f);
	private float planetLight = 1f;
	...
	/** sets the index for a custom render program created with RenderSystem.AddRenderProgram() */
	public void setCustomProgram(int i){ customRenderProgramIndex = i;}

	public void setIsPlanet (boolean p){isPlanet = p;}

	public void setShadowDirection (Vector4f direction) {shadowLightDirection = direction;}

	public void setPlanetLight (float light) {planetLight = light;}

	public void setShadowDistance (float distance) {shadowDistance = distance;}
	...
	/** returns whether this render state has a custom render program */
	public boolean hasCustomProgram(){ return customRenderProgramIndex >= 0;}

	/** returns the index of the custom render program for this render state */
	public int customProgramIndex(){ return customRenderProgramIndex;}

	public boolean getIsPlanet (){return isPlanet;}

	public Vector4f getShadowDirection(){return shadowLightDirection;}

	public float getPlanetLight(){return planetLight;}
