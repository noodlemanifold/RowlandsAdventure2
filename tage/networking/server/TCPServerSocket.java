 ...
 * 
 */
public class TCPServerSocket<K> extends ServerSocket implements IServerSocket {
	private GameConnectionServer<K> server;
	 ...
	 * @param gameConnectionServer
	 *            server to process packets
	 * @throws IOException
	 */
	public TCPServerSocket(int localPort, GameConnectionServer<K> gameConnectionServer)
			throws IOException {
		super(localPort);

		this.server = gameConnectionServer;
		running = true;
	...
	protected GameConnectionServer<K> getServer() {
		return server;
	}
