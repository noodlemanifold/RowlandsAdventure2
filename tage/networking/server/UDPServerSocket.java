 ...
 * 
 */
public class UDPServerSocket<K> extends DatagramSocket implements IServerSocket {
	 ...
	 */
	public UDPServerSocket(int localPort, GameConnectionServer<K> server)
			throws SocketException {
		super(localPort);
	...
	public IClientInfo createClientInfo(InetAddress clientAddr, int clientPort) {
		return new UDPClientInfo<K>(clientAddr, clientPort, this);
	}
