...
public class Engine
{
	...
	public Engine(VariableFrameRateGame v, boolean debug){	
		//arcane magic to clear the console window
		...
		//move this later in the load queue so the first physics step isnt huge and simulates
		//a bunch of stuff while were still loading in
