...
public abstract class VariableFrameRateGame implements KeyListener, MouseListener, MouseMotionListener, MouseWheelListener
{
	...
	*/
	...
	/** Use this function to build custom render programs */
	public void buildCustomRenderPrograms(RenderSystem rs){}

	/** Use this function to build any objects that need compute shaders to initialize */
	...
	*/
	...
	/**
	 * Called by the engine whenever the window is resized
	 */
	public void resized(){
