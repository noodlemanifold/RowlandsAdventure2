...
public class GameServerUDP extends GameConnectionServer<UUID> 
{
	...
	public void processPacket(Object o, InetAddress senderIP, int senderPort)
	{
		...
		{	// JOIN -- Case where client just joined the server
			...
			{	UUID clientID = UUID.fromString(messageTokens[1]);
				String state = messageTokens[2];
				int texI = Integer.parseInt(messageTokens[3]);
				sendCreateMessages(clientID, state, texI);
			...
			{	UUID clientID = UUID.fromString(messageTokens[1]);
				...
				String state = messageTokens[3];
				int texI = Integer.parseInt(messageTokens[4]);
				sendDetailsForMessage(clientID, remoteID, state, texI);
			}
			...
			{	UUID clientID = UUID.fromString(messageTokens[1]);
				String state = messageTokens[2];
				sendMoveMessages(clientID, state);
	}	}	}
	...
	public void sendCreateMessages(UUID clientID, String state, int texIndex)
	{	try 
	...
	public void sendDetailsForMessage(UUID clientID, UUID remoteId, String state, int texIndex)
	{	try 
	...
	public void sendMoveMessages(UUID clientID, String state)
	{	try 
